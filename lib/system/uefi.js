define(['version', 'display'], function(appversion, display) {
    ...
    var prodMode = appversion.production,
        ...
        environment = {
            ...
            shim: {
                'lib/es5-shim/es5-shim': ['lib/es5-shim/es5-sham'],
                'lib/es6-shim/es6-sham': ['lib/es5-shim/es5-shim'],
                'lib/es6-shim/es6-shim': ['lib/es6-shim/es6-sham'],
                'lib/system/kernel': ['lib/es6-shim/es6-shim', 'crypto', 'jquery']
            }
        };
