define(['require', 'exports', 'application'], function(require, exports, application) {
    ...
    module.config(['$provide', function($provide) {
        ...
        return {
            ...
            link: function(scope, elm, attr, ctrl) {
                ...
                attr.$observe('charset', function(value) {
                ...
                ctrl.$validators.maxbytes = function(modelValue, viewValue) {
                    if ((maxlength < 0) || ctrl.$isEmpty(viewValue)) return true;
                    var l = bytesOfStr(viewValue, charset);
                    return (l !== -1) && (l <= maxlength);
                };
            }
        }
        ...
        return {
            ...
            link: function(scope, elm, attr, ctrl) {
                ...
                ctrl.$validators.minbytes = function(modelValue, viewValue) {
                    if (ctrl.$isEmpty(viewValue)) return true;
                    var l = bytesOfStr(viewValue, charset);
                    return (l !== -1) && (l >= minlength);
                };
            }
        };
    ...
    function bytesOfStr(value, charset) {
        var len = 0;
        switch (charset) {
            //see https://en.wikipedia.org/wiki/GBK_(character_encoding)#GBK_1.0
            case 'gbk':
            ...
            case 'utf8':
                Array.from(value).forEach(function(value) {
                    ...
                    else if (cp <= 0x10FFFF) len += 4;
                    else return -1; //unknow codepoint
                });
                break;
        }
        return len
